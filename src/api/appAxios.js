...
const getTrendMovie = () =>
  axios.create({
    baseURL: `https://api.themoviedb.org/3/trending/movie/week?api_key=${process.env.REACT_APP_API_KEY}&language=en-US`,
  });
...
export { getPopularMovie, getTrendMovie, getMovieInfo };
